...
$DOCKER_COMPOSE exec -T app node /app/node_modules/prisma/build/index.js migrate deploy

echo "🔄 Generating Prisma Client..."
$DOCKER_COMPOSE exec -T app node /app/node_modules/prisma/build/index.js generate
